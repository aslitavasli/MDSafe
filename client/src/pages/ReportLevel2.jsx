...
export default function ReportLevel2() {
  ...
  return (
    <div className="container mt-5">
      <h2 className="text-center mb-4 custom-title">You have reported Level 2... </h2>
      <h3 className="text-center mb-4 custom-subtitle">Local security will be here momentarily.</h3>
